                ...
                <form action="{{ route('guest.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-blue-500 mt-1 italic">*Nomor antrian dibuat otomatis oleh sistem</p>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="text-xs text-gray-500 mt-2 ml-1">Masukkan NIM/NIP lalu klik <strong>CEK DATA</strong> untuk isi otomatis.</p>
                        </div>

                        {{-- Nama Lengkap --}}
                        <div class="md:col-span-2">
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Nama Lengkap <span class="text-pink-500">*</span></label>
                            <input name="nama_lengkap" id="nama_lengkap" type="text" required placeholder="Masukkan nama lengkap Anda..." 
                        ...
                        {{-- MODIFIED: Asal Instansi (Dynamic Loop) --}}
                        <div class="md:col-span-2">
...
<select name="keperluan" id="keperluan" required onchange="toggleKeperluanLainnya()"
    ...
    <option value="Lainnya">Lainnya (Sebutkan...)</option>
                        ...
                        {{-- Input Textarea Lainnya --}}
                        <div class="md:col-span-2 hidden transition-all duration-300 ease-in-out transform origin-top" id="input_keperluan_lainnya">
                            <label class="block text-sm font-bold text-blue-600 mb-2">Sebutkan Keperluan Lainnya <span class="text-pink-500">*</span></label>
                            <textarea name="keperluan_lainnya" id="keperluan_lainnya" rows="3" placeholder="Jelaskan keperluan Anda secara spesifik..." 
...
<script>
    // --- 1. TOGGLE KEPERLUAN (Native JS) ---
    // Ditaruh diluar ready agar bisa diakses onchange HTML
    function toggleKeperluanLainnya() {
        ...
        if (selectKeperluan && selectKeperluan.value === 'Lainnya') {
            divLainnya.classList.remove('hidden');
            txtLainnya.setAttribute('required', 'required');
            setTimeout(() => txtLainnya.focus(), 100); // Sedikit delay agar transisi smooth
        } else {
